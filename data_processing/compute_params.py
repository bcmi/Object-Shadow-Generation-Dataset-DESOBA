...
###### ISTD dataset #####
# sd_path = '../dataset/ISTD_Dataset/train/train_A'
# mask_path = '../dataset/ISTD_Dataset/train/train_B'
# sdfree_path = '../dataset/ISTD_Dataset/train/train_C'
# out = '../dataset/ISTD_Dataset/train/train_params/'
###### ISTD dataset #####

sd_path = '../dataset/ISTD_Dataset/test/test_A'
mask_path = '../dataset/ISTD_Dataset/test/test_B'
sdfree_path = '../dataset/ISTD_Dataset/train/train_C'
out = '../dataset/ISTD_Dataset/test/test_params/'
...
for im in im_list[:]:
    ...
    ### create fake files 
    # sdfree = 2* np.asarray(Image.open(join(sd_path,im)))
