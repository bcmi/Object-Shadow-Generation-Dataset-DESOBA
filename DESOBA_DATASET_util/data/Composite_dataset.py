...
def generate_training_pairs(shadow_image, deshadowed_image, instance_mask, shadow_mask, new_shadow_mask,  is_train, foreground_object_num,\
                            birdy_deshadoweds, birdy_shadoweds,  birdy_fg_instances, birdy_fg_shadows,  birdy_bg_instances,  birdy_bg_shadows, birdy_edges,  birdy_new_shadow_masks, birdy_max_objects):
    ...
    if len(instance_pixels)<1:
        return birdy_deshadoweds, birdy_shadoweds,  birdy_fg_instances, birdy_fg_shadows,  birdy_bg_instances,  birdy_bg_shadows,birdy_edges,  birdy_new_shadow_masks, birdy_max_objects
...
class CompositeDataset(BaseDataset):
    def initialize(self, opt):
        ...
        self.dir_bg_instance = opt.instance_path
        self.dir_bg_shadow = opt.shadow_path
        self.dir_new_mask = opt.new_mask_path
        self.foreground_object_num = opt.foreground_object_num
        ...
        for imname_list in self.imname:
            ...
            self.birdy_bg_shadows, self.birdy_edges,  self.birdy_new_shadow_masks, self.birdy_max_objects = generate_training_pairs( \
                A_img_array, C_img_arry, instance_array, shadow_array, new_mask_array,  self.is_train,self.foreground_object_num, \
                self.birdy_deshadoweds, self.birdy_shadoweds,  self.birdy_fg_instances, self.birdy_fg_shadows, \
                self.birdy_bg_instances,  self.birdy_bg_shadows, self.birdy_edges,  self.birdy_new_shadow_masks, self.birdy_max_objects)
